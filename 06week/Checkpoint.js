...
// Here I would want to use a map function and return and new array
...
// trying to see if I use the 2 methods 
// I would want to use a filter method 
// then reduce to add all the filtered even numbers
...
// I would want to use a findIndex method 
...
//create an array of the unique 'weather_state_name' values of the weather array. Your function should return the following array ['Light Cloud', 'Heavy Cloud', 'Showers']
// I would need to use a indexof method
// then would need to specify not to use duplicates
// and a map functionm to target the keys
...
// I would need to filter the min tempature 
// then map and sort the correct data
